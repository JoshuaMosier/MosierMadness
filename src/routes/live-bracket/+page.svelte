<center><h2>Master Bracket</h2></center>
  <!-- Bracket -->
<body class="bracket standings light-blue nav-spacer-scoreboard">
...
<!-- /#match33 -->
        <div id="match33" class="match m1">
          <p class="slot slot1"> Team Placeholder
          </p>
          <p class="slot slot2" > Team Placeholder
          </p>
        </div>
...
#bracket #round6 .slot1 {
  border-bottom: 2px groove #E55300;
  top: 22px;
}
...
#bracket .match .slot1:hover{
  background-color: gray
}
#bracket .match .slot2:hover{
  background-color: gray;
}
#bracket .match .slot1 {
  top: 0px;

 ...
 */
export function getEasternDateParts(date: Date = new Date()): DateParts {
 ...
 */
export function parseDateParts(dateValue: Date | string = new Date()): DateParts {
 ...
 */
export function formatContestDate(dateValue: Date | string = new Date()): string {
 ...
 */
export function getTodayEtDateString(date: Date = new Date()): string {
 ...
 */
export function getSeasonYear(dateValue: Date | string = new Date()): number {
